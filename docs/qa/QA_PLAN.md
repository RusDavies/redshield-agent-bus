...
- Run `python3 scripts/agent_bus_verify.py armor-enforcement tests/fixtures/armor_enforcement --pretty`.
...
- Integrated envelope validation that includes Warden and Armor result objects.
