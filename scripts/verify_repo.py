...
OPEN_CORE_REQUIRED_PATHS = [
    ...
    "tests/fixtures/capability_grants/invalid-action-mapping.json",
    "tests/fixtures/capability_grants/invalid-expired-grant.json",
    "tests/fixtures/capability_grants/valid-redshieldworks-core-grant.json",
